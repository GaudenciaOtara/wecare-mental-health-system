...
if (isset($_SESSION['user'])){
    ...
    // echo $_SESSION['user'];
    $user_query = mysqli_query($conn,"select * from doctor where email='{$_SESSION["user"]}'");
                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    ...
                                    <div class="user-details">
                                        <span id="more-details"> Dr <?php echo $user_data['fullname'];
                            ...
                            <div class="pcoded-navigation-label">Therapy Sessions</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="chats.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext">Start Session</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            </ul>
                            <div class="pcoded-navigation-label">Patient Feedback</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="feedback.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-receipt"></i><b>B</b></span>
                                        <span class="pcoded-mtext">Reviews & Feedback</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            </ul>
                            <div class="pcoded-navigation-label">Research And Stats</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                            ...
                            <div class="pcoded-navigation-label">Your Patients</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu ">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="appointments.php" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="progress.php" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="groups.php" class="waves-effect waves-dark">
                                                ...
                                                <span class="pcoded-mtext">Community Groups</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
